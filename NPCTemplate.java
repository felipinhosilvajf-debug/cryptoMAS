...
public final class NpcTemplate extends CharTemplate
{
	...
	public NpcInstance getNewInstance()
	{
		...
		{
			//_log.log(Level.SEVERE, "Unable to create instance of NPC " + npcId, e);
		}
	...
	private void setType(String type)
	{
		...
		try
		{
			classType = (Class<NpcInstance>) Class.forName("l2f.gameserver.model.instances." + type + "Instance");
		}
	...
	private void setAI(String ai)
	{
		...
		try
		{
			classAI = (Class<CharacterAI>) Class.forName("l2f.gameserver.ai." + ai);
		}
		catch (ClassNotFoundException e)
		{
